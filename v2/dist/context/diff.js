...
export function parseUnifiedHunkHeader(line) {
...
export function mapPatchLines(patch) {
    const mapped = [];
 ...
 */
export function isChangedLine(patch, line) {
    return mapPatchLines(patch).some((mapped) => mapped.newLine === line && mapped.type !== 'deletion');
}
