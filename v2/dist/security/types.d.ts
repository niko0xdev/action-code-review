...
export type SecurityStatus = 'candidate' | 'validated' | 'rejected' | 'needs_review';
export type SecurityExploitability = 'confirmed' | 'likely' | 'theoretical' | 'unknown';
export type RiskLevel = 'critical' | 'high' | 'medium' | 'low' | 'none';
export type RiskClassificationLevel = 'low' | 'medium' | 'high' | 'critical_surface';
...
export declare const SEVERITY_RANKS: Record<SecuritySeverity, number>;
export declare const CONFIDENCE_RANKS: Record<SecurityConfidence, number>;
export declare const RISK_LEVEL_ORDER: Record<RiskClassificationLevel, number>;
